...
public class SqlQueryConstantsUtil {
    ...
    // CLM Data
    public static final String SQL_GET_CLM_DATA =
        "SELECT CUST_REGISTRY_ID, FPH_DESCRIPTION_TIER_4, FPH_DESCRIPTION_TIER_5, FPH_DESCRIPTION_TIER_6, FPH_DESCRIPTION_TIER_7, PROD_TIER_9, CONTRACT_NBR, QUANTITY, QUANTITY_UNIT_OF_MEASURE FROM CLM_DATA WHERE CUST_REGISTRY_ID = (SELECT REGISTRY_ID FROM USERS WHERE USER_ID = ?) AND FPH_DESCRIPTION_TIER_4 = 'Public Cloud - IaaS' AND SUB_LINE_STATUS = 'ACTIVE' AND FPH_DESCRIPTION_TIER_6 NOT LIKE 'IaaS Public Cloud%' AND FPH_DESCRIPTION_TIER_7 NOT LIKE 'Diva Cloud Service%'";
   public static final String SQL_GET_CUSTOMER_REGISTRY_DATA = 
    ...
    public static final String SQL_USER_QUERY = "SELECT USER_ID, EMAIL, USER_ROLE, FIRST_NAME, LAST_NAME, REGISTRY_ID, PHONE FROM USERS";
        public static final String SQL_UPDATE_USER_QUERY = "UPDATE USERS SET EMAIL = ?, USER_ROLE = ? , FIRST_NAME = ?, LAST_NAME = ? , REGISTRY_ID = ?, PHONE = ? WHERE USER_ID = ?";
}
