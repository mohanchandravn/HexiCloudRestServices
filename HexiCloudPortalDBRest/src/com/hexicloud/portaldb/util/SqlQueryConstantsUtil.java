...
public class SqlQueryConstantsUtil {
   ...
   public static final String SQL_GET_CUSTOMER_REGISTRY_DATA = 
    ...
    public static final String SQL_USER_QUERY = "SELECT USER_ID, EMAIL, USER_ROLE, FIRST_NAME, LAST_NAME, REGISTRY_ID FROM USERS";
        public static final String SQL_UPDATE_USER_QUERY = "UPDATE USERS SET EMAIL = ?, USER_ROLE = ? , FIRST_NAME = ?, LAST_NAME = ? , REGISTRY_ID = ? WHERE USER_ID = ?";
