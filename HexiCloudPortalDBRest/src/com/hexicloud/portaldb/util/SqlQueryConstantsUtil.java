...
public class SqlQueryConstantsUtil {
    ...
    public static final String SQL_CREATE_JOB_CONFIGURATION =
        "INSERT INTO JOB_CONFIGURATION (JOB_NAME,JOB_DESCRIPTION,JOB_FREQUENCY,JOB_FREQUENCY_TYPE,CLASS_NAME,JOB_FREQUENCY_HOUR,JOB_FREQUENCY_MINUTE,JOB_STATUS) values ( ?, ?, ?, ?, ?, ?, ?, ?)";

    public static final String SQL_UPDATE_JOB_CONFIGURATION =
        "UPDATE JOB_CONFIGURATION SET JOB_FREQUENCY = ?, JOB_FREQUENCY_TYPE = ?, JOB_FREQUENCY_HOUR = ?, JOB_FREQUENCY_MINUTE = ? WHERE JOB_ID = ?";
    
    public static final String SQL_DELETE_JOB_CONFIGURATION = 
        "DELETE FROM JOB_CONFIGURATION WHERE JOB_ID = ? ";
    
    public static final String SQL_UPDATE_JOB_CONFIGURATION_STATUS = 
        "UPDATE JOB_CONFIGURATION SET JOB_STATUS = ? WHERE JOB_ID = ? ";
}
