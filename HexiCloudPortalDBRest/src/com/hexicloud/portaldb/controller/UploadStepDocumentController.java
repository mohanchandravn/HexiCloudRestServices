...
public class UploadStepDocumentController {
            ...
            if (multipartFile != null) {
                if (paramMap != null && !(paramMap.isEmpty())) {
                    ...
                    while (parameterEntries.hasNext()) {
                        ...
                        stepDocumentInput = mapper.readValue(paramValue[0].getBytes(), UploadStepDocument.class);
                ...
                stepDocumentInput.setSubStepFolderName(stepDocumentInput.getSubStepCode() != null ?
                                                       stepDocumentInput.getSubStepCode().toUpperCase() : null);
                ...
                if (folderId != null) {
                    uploadResponse =
                        uploadStepDocumentService.uploadDocument(multipartFile, folderId,
                                                                 stepDocumentInput.getDocFieldId()); //upload the document
              ...
              uploadStepDocumentService.createFilePublicLink(uploadResponse.getId());
                            ...
                            AppLinkResponse appLinkResponse =
                                uploadStepDocumentService.createFileAppLink(uploadResponse.getId());
                            ...
                            StepDocument stepDocument =
                                this.createStepDocumentRequest(stepDocumentInput, uploadResponse, publicLinkResponse,
                                                               appLinkResponse);
    ...
    private StepDocument createStepDocumentRequest(UploadStepDocument stepDocumentInput,
                                                   DocumentUploadReponse uploadResponse,
                                                   PublicLinkResponse publicLinkResponse,
                                                   AppLinkResponse appLinkResponse) {
        StepDocument stepDocument = null;
        if (stepDocumentInput != null && uploadResponse != null) {
            stepDocument = new StepDocument();
            stepDocument.setStepId(stepDocumentInput.getStepId() != null ?
                                   Integer.valueOf(stepDocumentInput.getStepId()) : -1);
            ...
            stepDocument.setDisplayOrder(stepDocumentInput.getDisplayOrder() != null ?
                                         Integer.valueOf(stepDocumentInput.getDisplayOrder()) : 0);
