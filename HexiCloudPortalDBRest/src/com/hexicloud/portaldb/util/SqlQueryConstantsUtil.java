...
public class SqlQueryConstantsUtil {
    ...
    public static final String SQL_CREATE_JOB_CONFIGURATION =
        "INSERT INTO JOB_CONFIGURATION (JOB_ID,JOB_NAME,JOB_DESCRIPTION,JOB_FREQUENCY,JOB_FREQUENCY_TYPE,CLASS_NAME,JOB_FREQUENCY_HOUR,JOB_FREQUENCY_MINUTE,JOB_STATUS) values (SELECT JOB_CONFIGURATION_ID_S.NEXTVAL FROM DUAL , ?, ?, ?, ?, ?, ?, ?, ?)";
