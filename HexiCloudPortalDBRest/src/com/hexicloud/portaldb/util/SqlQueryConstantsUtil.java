...
public class SqlQueryConstantsUtil {
    ...
    public static final String SQL_GET_UNIQUE_TIER_6 =
        "SELECT UNIQUE(FPH_DESCRIPTION_TIER_6) FROM CLM_DATA_TEMP WHERE FPH_DESCRIPTION_TIER_4 IN ('Public Cloud - IaaS') AND SUB_LINE_STATUS = 'ACTIVE' AND FPH_DESCRIPTION_TIER_6 NOT LIKE 'IaaS Public Cloud%'";
}
