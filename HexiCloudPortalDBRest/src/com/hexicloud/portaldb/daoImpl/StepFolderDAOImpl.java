...
public class StepFolderDAOImpl implements StepFolderDAO {
    ...
    public List<StepFolder> retrieveStepFolderDetails(String stepId) {
        ...
        List<StepFolder> listOfSteFolders =
            jdbcTemplate.query(SqlQueryConstantsUtil.SQL_FIND_STEP_FOLDERS_BY_STEP_ID, new Object[] { stepId },
    ...
    public void addStepFolder(StepFolder stepFolder) {
        jdbcTemplate.update(SqlQueryConstantsUtil.SQL_CREATE_STEP_FOLDER,
                            new Object[] { stepFolder.getStepId(), stepFolder.getStepCode(),
                                           stepFolder.getSubStepCode(), stepFolder.getFolderId() });
    }
